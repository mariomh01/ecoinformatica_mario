---
title: "Entregable Reproducibilidad-control versiones"
author: "Mario"
date: "`r Sys.Date()`"
...
```{r}
datos_TFG<- read.csv("C:/Users/mario/Desktop/Repositorio_Git_Mario/Extracto_TFG_Mario.csv")

df<- read_delim("C:/Users/mario/Desktop/Repositorio_Git_Mario/Extracto_TFG_Mario.csv", delim = ";")
...
La alta densidad del banco de semillas de la especie de estudion debe tenerse en cuenta al planificar y ejecutar protocolos de control de la misma, especialmente si se trata de eliminar la parte aérea de la planta, ya que tal densidad del banco de semillas supone un alto potencial de regeneración
